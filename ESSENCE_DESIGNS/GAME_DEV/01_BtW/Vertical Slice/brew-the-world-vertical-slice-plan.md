# BREW the WORLD — Vertical Slice Plan

*Working reference document. Scope, cast roster, and the bridge-relationship pattern for characters not physically present early. Companion to the cast bible, style bible, and macro structure.*
...
## Design Goal: Chosen Family Mirrors Blood Family, From Day 1

Fennel's hunting party — Fox, Mugwort, Falcon — needs to read as her chosen family with the same immediacy her blood family does, from the first time the player meets them. Introduced day one, not built up to. This is a deliberate structural choice: the same "unity was already there, unassembled" thesis that runs through the whole cast web applies to Fennel's own inner circle, not just the village at large.
...
**Craft-family peers (the next generation of the three trade domains):**
Coal (Badger's craft), Millet (Loam's provisions), Ferret (Weasel's ledgers) — Fennel's direct friends, each carrying a piece of their parent's arc forward without fully understanding it yet.

**Craft-family faces (the adults Fennel actually transacts with):**
Badger, Loam, Weasel — present as working village adults Fennel interacts with directly through the shop and market, distinct from their kids' friendship-tier relationship to her.

**Ambient/background presence (seen, not deeply engaged yet):**
Marigold, Barley — visible and consistent with the macro structure's Act 1 rule (Orchard presence ambient, unremarked; Barley present as an enforcer who believes what he does is mercy, not yet tested).

---

## The Bridge-Relationship Pattern

Some characters don't appear physically until much later acts, but the *player* should be able to feel their presence in the web from Day 1 through someone who is on screen. A bridge character carries the absent one's weight into early scenes without requiring the absent character to be modeled, voiced, or scheduled that early — this is what actually protects scope while keeping the web feeling complete.
...
*Draft — scope and roster locked for planning purposes; bridge pattern established as a reusable design tool, not exhausted yet.*
